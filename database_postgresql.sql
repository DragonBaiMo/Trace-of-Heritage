-- ============================================================================
-- 寻戏之旅——经典戏曲文化分享互动管理系统的设计与实现（Trace-of-Heritage）PostgreSQL版本数据库DDL脚本
-- ============================================================================
-- 项目名称：寻戏之旅——经典戏曲文化分享互动管理系统的设计与实现 - 非遗/戏曲数字化平台
-- 版本：0.2.0
-- 数据库类型：PostgreSQL 12+
...
VALUES (
  '平台上线公告',
  '欢迎使用寻戏之旅——经典戏曲文化分享互动管理系统的设计与实现非遗数字化平台！本平台旨在为非遗文化爱好者提供分享、交流和学习的空间。',
  'all',
  'published',
  CURRENT_TIMESTAMP
